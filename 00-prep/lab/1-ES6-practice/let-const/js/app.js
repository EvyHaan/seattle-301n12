...
function displayPics(){
  ...
  // console.log(rando) is throwing an error as the variable 'rando' is declaried only within the preceding code block, and cannot be reached, even locally to the function by the console.log which is defined outside of that block.
  console.log(viewed);
